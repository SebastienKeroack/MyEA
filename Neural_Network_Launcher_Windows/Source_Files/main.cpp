...
#endif
{
    ...
    PRINT_FORMAT("%s: \tCopyright Sebastien Keroack" NEW_LINE, MyEA::String::Get__Time().c_str());
    PRINT_FORMAT("%s: ******************************************" NEW_LINE, MyEA::String::Get__Time().c_str());
    PRINT_FORMAT("%s" NEW_LINE, MyEA::String::Get__Time().c_str());
...
#if defined(COMPILE_WINDOWS)
    class Shutdown_Block tmp_Shutdown_Block("Neural Network Launcher Windows", "CLASS_Neural_Network_Launcher_Windows");
#elif defined(COMPILE_LINUX)
    class Shutdown_Block tmp_Shutdown_Block("Neural Network Launcher Windows");
#endif
    ...
    while(true)
    {
        ...
        PRINT_FORMAT("%s: \t[0]: Optimization." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[1]: Pre-training." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[2]: Transfer learning." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[3]: Framework." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[4]: Grid search." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[5]: [DEPRECATED] Random search." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[6]: Count identical output(s) entrie(s)." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[7]: Simulate classification trading session." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[8]: Preprocessing." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[9]: Dataset datapoint." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[10]: Quit." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s" NEW_LINE, MyEA::String::Get__Time().c_str());
