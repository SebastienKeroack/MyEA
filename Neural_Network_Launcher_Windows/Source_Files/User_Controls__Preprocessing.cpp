...
bool User_Controls__Preprocessing(void)
{
    ...
    while(true)
    {
        ...
        PRINT_FORMAT("%s: \t[0]: Autoencoder dataset." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[1]: Concat." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[2]: Custom." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[3]: Input(s) to output(s)." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[4]: Merge dataset." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[5]: Minimum maximum (MinMax)." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[6]: Maximum overlap discrete wavelet transform (MODWT)." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[7]: Remove duplicate entrie(s)." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[8]: Remove IO." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[9]: Replace entrie(s)." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[10]: Sequential input." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[11]: Shift entrie(s)." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[12]: Spliting dataset." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[13]: Time-direction." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[14]: Unrecurrent." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[15]: Zero centered." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: \t[16]: Quit." NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s" NEW_LINE, MyEA::String::Get__Time().c_str());

        switch(MyEA::String::Cin_Number<unsigned int>(0u,
                                                                                16u,
                                                                                MyEA::String::Get__Time() + ": Choose an option: "))
        {
            case 0u:
                PRINT_FORMAT("%s" NEW_LINE, MyEA::String::Get__Time().c_str());
