...
bool Dataset__Datapoint(void)
{
    ...
    enum ENUM_TYPE_INPUT const tmp_type_input(MyEA::String::NoOrYes(MyEA::String::Get__Time() + ": Do you want to datapoint input(s)?") ? ENUM_TYPE_INPUT::TYPE_INPUT_INPUT : ENUM_TYPE_INPUT::TYPE_INPUT_OUTPUT);
    ...
    {
        PRINT_FORMAT("%s" NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: Input index." NEW_LINE, MyEA::String::Get__Time().c_str());
        ...
        int const tmp_input_index(MyEA::String::Cin_Number<int>(-1,
                                                                                              ...
                                                                                              MyEA::String::Get__Time() + ": Input index: "));

        PRINT_FORMAT("%s" NEW_LINE, MyEA::String::Get__Time().c_str());
        PRINT_FORMAT("%s: FORM: Plot dataset manager... ", MyEA::String::Get__Time().c_str());
    ...
    while(MyEA::String::NoOrYes(MyEA::String::Get__Time() + ": " + NEW_LINE + MyEA::String::Get__Time() + ": Do you want to datapoint again?"));
#endif
