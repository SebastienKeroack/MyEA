...
constexpr std::streamsize operator ""_ss(unsigned long long int variable_to_size_t_received)
{ return(static_cast<std::streamsize>(variable_to_size_t_received)); } // http://en.cppreference.com/w/cpp/language/user_literal
...
namespace MyEA
{
    namespace String
    {
        ...
        template <typename T> bool Parse_Number(char *&ptr_array_characters,
                                                                         char *const ptr_last_character,
                                                                         T &ref_output);
        template <typename T> bool Parse_Real_Number(char *&ptr_array_characters,
                                                                                 char *const ptr_last_character,
                                                                                 T &ref_output);
        ...
        template <typename T> bool Read_Stream_Block_And_Parse_Real_Number(char *&ptr_array_characters_received,
                                                                                                                        ...
                                                                                                                        std::ifstream &ref_ifstream_received,
                                                                                                                        char const until_reach_received = 0x00);
        template <typename T> bool Read_Stream_Block_And_Parse_Number(char *&ptr_array_characters_received,
                                                                                                                char *&ptr_last_character_received,
                                                                                                                size_t &ref_block_size_received,
                                                                                                                size_t const desired_block_size_received,
                                                                                                                size_t const step_block_size_received,
        ...
        template <typename T> T Cin_Number(T const minimum_number_received, std::string const &ref_prefix_received = "Number: ");
        template <typename T> T Cin_Number(T const minimum_number_received,
                                                                 T const maximum_number_received,
                                                                 std::string const &ref_prefix_received = "Number: ");

        template <typename T> T Cin_Real_Number(T const minimum_real_number_received, std::string const &ref_prefix_received = "Number: ");
        template <typename T> T Cin_Real_Number(T const minimum_real_number_received,
        ...
        template<class T, enum MyEA::String::ENUM_TYPE_MANIPULATOR_STRING TYPE> std::string To_string(T const value_received, unsigned int const number_precision_received = 16u)
        {
