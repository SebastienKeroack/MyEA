...
#if defined(COMPILE_ADEPT)
    static T_ operator ""_T(unsigned long long int variable_to_size_t_received) { return(static_cast<T_>(variable_to_size_t_received)); }

    static T_ operator ""_T(long double variable_to_size_t_received) { return(static_cast<T_>(variable_to_size_t_received)); }
#else
    constexpr T_ operator ""_T(unsigned long long int variable_to_size_t_received) { return(static_cast<T_>(variable_to_size_t_received)); }
...
constexpr size_t operator ""_zu(unsigned long long int variable_to_size_t_received) { return(static_cast<size_t>(variable_to_size_t_received)); }
    
constexpr size_t KILOBYTE(1024_zu);
...
#else
    #define TYPE_CPU_COMPILE "UNKNOW"
#endif
...
void string_cat(char *destination_received, size_t const sizeof_received, char const *const source_received);
...
void string_copy(char *destination_received, size_t const sizeof_received, char const *const source_received);
