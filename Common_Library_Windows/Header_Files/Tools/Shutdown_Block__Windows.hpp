...
class Shutdown_Block
{
    public:
        Shutdown_Block(std::string const &ref_window_name_received, std::string const &ref_class_name_received);
        ~Shutdown_Block(void);
...
extern class Shutdown_Block *ptr_global_Shutdown_Block;