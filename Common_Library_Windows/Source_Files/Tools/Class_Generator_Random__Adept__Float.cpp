    ...
    namespace Common
    {
        ...
        class Class_Generator_Random_Real<adept::afloat> : public Class_Generator_Random
        {
            public:
                ...
                {
                    adept::afloat tmp_minimum_range(min(minimum_range_received, maximum_range_received)),
            ...
            private:
                float _minimum_range = 0;
                float _maximum_range = 1;
        ...
        class Class_Generator_Random_Bernoulli<adept::afloat> : public Class_Generator_Random
        {
            public:
                ...
                {
                    if(probability_received < 0.0f || probability_received > 1.0f) { return; }
