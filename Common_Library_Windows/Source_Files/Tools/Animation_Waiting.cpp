...
namespace MyEA
{
    namespace Animation
    {
        ...
        void Animation_Waiting::Continue(void) { this->_continue.store(true); }

        void Animation_Waiting::Stop(void) { this->_continue.store(false); }
        ...
        void Animation_Waiting::Print(void)
        {
            ...
            if(++this->_bytes == 3) { this->_bytes = 0; }
        }
