...
void Key_Logger::Clear_Keys_Pressed(void) { this->_map_chars.clear(); }
...
bool Key_Logger::Trigger_Key(char const char_received) { return(this->_map_chars.find(char_received) !=std::string::npos); }