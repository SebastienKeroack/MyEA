...
void Neural_Network::RNN__Forward_Pass_Batch__OpenMP(size_t const batch_size_received,
                                                                                          ...
                                                                                          struct Layer const *const ptr_last_layer_received)
{
    ...
    // Input layer.
    this->RNN__Assign_Inputs__OpenMP(batch_size_received, ptr_array_inputs_received);
    // |END| Input layer. |END|
    ...
    for(; tmp_ptr_layer_it != ptr_last_layer_received; ++tmp_ptr_layer_it)
    {
        ...
        switch(tmp_ptr_layer_it->type_layer)
        {
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_AVERAGE_POOLING:
                this->Recurrent__Forward_Pass__Average_Pooling__OpenMP(batch_size_received,
            ...
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                this->Recurrent__Forward_Pass__FC__OpenMP(batch_size_received,
                                                                                        *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                                        tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                                        tmp_ptr_layer_it);
                    break;
            ...
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_MAX_POOLING:
                this->Recurrent__Forward_Pass__Max_Pooling__OpenMP(batch_size_received,
                                                                                                      *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                                                      tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                                                      tmp_ptr_layer_it);
                    break;
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_RESIDUAL: this->Recurrent__Forward_Pass__Residual__OpenMP(batch_size_received, tmp_ptr_layer_it); break;
            default:
...
void Neural_Network::RNN__Forward_Pass_Batch__Pre_Training__OpenMP(size_t const batch_size_received, T_ const *const *const ptr_array_inputs_received)
{
    ...
    for(; tmp_ptr_layer_it != tmp_ptr_last_layer; ++tmp_ptr_layer_it)
    {
        ...
        switch(tmp_ptr_layer_it->type_layer)
        {
            ...
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_RECURRENT:
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                this->Recurrent__Forward_Pass__Encode__FC__OpenMP(batch_size_received,
                                                                                                         *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                                                         tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                                                         tmp_ptr_layer_it);
                    break;
    ...
    switch(tmp_ptr_layer_it->type_layer)
    {
        ...
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_RECURRENT:
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
            this->Recurrent__Forward_Pass__Code__FC__OpenMP(batch_size_received,
                                                                                                    *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                                                    tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                                                    tmp_ptr_layer_it);
                break;
    ...
    switch(tmp_ptr_layer_it->type_layer)
    {
        ...
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_RECURRENT:
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
            this->Recurrent__Forward_Pass__Decode__FC__OpenMP(batch_size_received,
                                                                                                  *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                                                  tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                                                  tmp_ptr_layer_it);
                break;
...
void Neural_Network::Recurrent__Forward_Pass__Average_Pooling__OpenMP(size_t const batch_size_received,
...
void Neural_Network::Recurrent__Forward_Pass__Dropout__Bernoulli__Inference__OpenMP(size_t const batch_size_received,
                                                                                                                                      size_t const input_unit_size_received,
...
void Neural_Network::Recurrent__Forward_Pass__Dropout__ShakeDrop__OpenMP(size_t const batch_size_received,
                                                                                                                         size_t const input_unit_size_received,
...
void Neural_Network::Recurrent__Forward_Pass__FC__OpenMP(size_t const batch_size_received,
                                                                                               size_t const input_unit_size_received,
                                                                                               T_ const *const ptr_array_inputs_received,
                                                                                               struct Layer *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Forward_Pass__Encode__FC__OpenMP(size_t const batch_size_received,
                                                                                                             size_t const input_unit_size_received,
                                                                                                             T_ const *const ptr_array_inputs_received,
                                                                                                             struct Layer *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Forward_Pass__Code__FC__OpenMP(size_t const batch_size_received,
                                                                                                          size_t const input_unit_size_received,
                                                                                                          T_ const *const ptr_array_inputs_received,
                                                                                                          struct Layer *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Forward_Pass__Decode__FC__OpenMP(size_t const batch_size_received,
                                                                                                             size_t const input_unit_size_received,
                                                                                                             T_ const *const ptr_array_inputs_received,
                                                                                                             struct Layer *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Forward_Pass__LSTM__OpenMP(bool const forward_layer_received,
...
void Neural_Network::Recurrent__Forward_Pass__Encode__LSTM__OpenMP(bool const forward_layer_received,
                                                                                                            size_t const batch_size_received,
                                                                                                            size_t const input_unit_size_received,
                                                                                                            T_ const *const ptr_array_inputs_received,
                                                                                                            struct Layer *const ptr_layer_it_received)
...
void Neural_Network::Recurrent__Forward_Pass__Code__LSTM__OpenMP(bool const forward_layer_received,
                                                                                                        size_t const batch_size_received,
                                                                                                        size_t const input_unit_size_received,
                                                                                                        T_ const *const ptr_array_inputs_received,
                                                                                                        struct Layer *const ptr_layer_it_received)
...
void Neural_Network::Recurrent__Forward_Pass__Decode__LSTM__OpenMP(bool const forward_layer_received,
                                                                                                            size_t const batch_size_received,
                                                                                                            size_t const input_unit_size_received,
                                                                                                            T_ const *const ptr_array_inputs_received,
                                                                                                            struct Layer *const ptr_layer_it_received)
...
void Neural_Network::Recurrent__Forward_Pass__Max_Pooling__OpenMP(size_t const batch_size_received,
                                                                                                             size_t const input_unit_size_received,
                                                                                                             T_ const *const ptr_array_inputs_received,
                                                                                                             struct Layer *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Forward_Pass__Residual__OpenMP(size_t const batch_size_received, struct Layer *&ptr_layer_it_received)
{
    ...
    if(tmp_ptr_residual_layer->type_dropout == MyEA::Common::ENUM_TYPE_LAYER_DROPOUT::TYPE_LAYER_DROPOUT_SHAKEDROP)
    {
        ...
        if(this->type_state_propagation == MyEA::Common::ENUM_TYPE_STATE_PROPAGATION::TYPE_STATE_PROPAGATION_TRAINING)
        {
            this->Recurrent__Forward_Pass__Dropout__ShakeDrop__OpenMP(batch_size_received,
                                                                                                              *ptr_layer_it_received->ptr_number_outputs,
        ...
        {
            this->Recurrent__Forward_Pass__Dropout__Bernoulli__Inference__OpenMP(batch_size_received,
                                                                                                                           *ptr_layer_it_received->ptr_number_outputs,
    ...
    this->Recurrent__Forward_Pass__Zero_Padded_Identity__OpenMP(batch_size_received,
...
void Neural_Network::Recurrent__Forward_Pass__Residual__Layer__OpenMP(bool const is_block_input_layer_received,
                                                                                                                  size_t const batch_size_received,
...
void Neural_Network::Recurrent__Forward_Pass__Residual__FC__OpenMP(bool const is_block_input_layer_received,
                                                                                                              size_t const batch_size_received,
                                                                                                              size_t const input_unit_size_received,
                                                                                                              T_ const *const ptr_array_inputs_received,
                                                                                                              struct Layer *const ptr_layer_it_received)
...
void Neural_Network::Recurrent__Forward_Pass__Zero_Padded_Identity__OpenMP(size_t const batch_size_received,
...
void Neural_Network::Forward_Pass__FC_Ind_RNN__OpenMP(size_t const time_step_index_received,
                                                                                           size_t const batch_size_received,
...
void Neural_Network::Forward_Pass__LSTM__Gates_CIFO__OpenMP(long long int const time_step_index_received,
...
void Neural_Network::Forward_Pass__LSTM__Gates_CIF_AF_State__OpenMP(long long int const time_step_index_received,
                                                                                                                    long long int const time_step_reverse_direction_received,
                                                                                                                    long long int const time_step_prediction_start_received,
                                                                                                                    size_t const batch_size_received,
                                                                                                                    size_t const layer_block_unit_size_received,
...
void Neural_Network::Forward_Pass__LSTM__Gates_CIF_AF_State__Zoneout__OpenMP(long long int const time_step_index_received,
                                                                                                                                   long long int const time_step_reverse_direction_received,
                                                                                                                                   long long int const time_step_prediction_start_received,
                                                                                                                                   size_t const batch_size_received,
                                                                                                                                   size_t const layer_block_unit_size_received,
...
void Neural_Network::Forward_Pass__LSTM__Output__OpenMP(long long int const time_step_index_received,
                                                                                              size_t const batch_size_received,
                                                                                              size_t const layer_block_unit_size_received,
                                                                                              size_t const layer_cell_unit_size_received,
...
void Neural_Network::Forward_Pass__LSTM__Output__Zoneout__OpenMP(long long int const time_step_index_received,
                                                                                                              long long int const time_step_reverse_direction_received,
                                                                                                              long long int const time_step_prediction_start_received,
                                                                                                              size_t const batch_size_received,
                                                                                                              size_t const layer_block_unit_size_received,
...
void Neural_Network::Forward_Pass__LSTM__States_AF__OpenMP(long long int const time_step_index_received,
                                                                                                    size_t const batch_size_received,
                                                                                                    size_t const layer_block_unit_size_received,
                                                                                                    size_t const layer_cell_unit_size_received,
