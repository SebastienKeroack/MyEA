...
T_ Neural_Network::Get__Regularization__SRIP(void) const { return(this->regularization__srip); }

bool Neural_Network::Set__Regularization__SRIP(T_ const regularization__srip_received)
{
    ...
    if(this->regularization__srip != regularization__srip_received)
    {
        ...
        if(tmp_use_regularization == false && regularization__srip_received != 0_T)
        {
        ...
        { this->ptr_device_Neural_Network->Set__Regularization__L2(regularization__srip_received); }
    #endif
    }
...
void Neural_Network::Update_Derivative_Weight__Regularization__SRIP(size_t const start_index_received,
...
void Neural_Network::Update_Derivative_Weight__Regularization__SRIP__Loop(size_t const start_index_received,
                                                                                                                   size_t const end_index_received,
                                                                                                                   size_t const batch_size_received)
{
    ...
    { *tmp_ptr_gradient_it += *tmp_ptr_connections_mask_regularization_it * *tmp_ptr_weight_it * this->regularization__srip; }
}
    
void Neural_Network::Update_Derivative_Weight__Regularization__SRIP__OpenMP(size_t const start_index_received,
                                                                                                                         size_t const end_index_received,
                                                                                                                         size_t const batch_size_received)
{
    ...
    { tmp_ptr_array_gradients[tmp_connection_index] += tmp_ptr_array_connections_mask_regularization[tmp_connection_index] * tmp_ptr_array_parameters[tmp_connection_index] * this->regularization__srip; }
}
