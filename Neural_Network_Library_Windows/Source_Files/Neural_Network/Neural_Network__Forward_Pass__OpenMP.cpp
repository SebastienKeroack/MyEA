...
void Neural_Network::FF__Forward_Pass_Batch__OpenMP(size_t const batch_size_received,
                                                                                       ...
                                                                                       struct Layer const *const ptr_last_layer_received)
{
    ...
    // Input layer.
    this->FF__Assign_Inputs__OpenMP(batch_size_received, ptr_array_inputs_received);
    // |END| Input layer. |END|
    ...
    for(; tmp_ptr_layer_it != ptr_last_layer_received; ++tmp_ptr_layer_it)
    {
        ...
        switch(tmp_ptr_layer_it->type_layer)
        {
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_AVERAGE_POOLING:
                this->Forward_Pass__Average_Pooling__OpenMP(0_zu,
                                                                                          batch_size_received,
            ...
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED:
                this->Forward_Pass__FC__OpenMP(0_zu,
                                                                     batch_size_received,
                                                                     *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                     tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                     tmp_ptr_layer_it);
            ...
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_MAX_POOLING:
                this->Forward_Pass__Max_Pooling__OpenMP(0_zu,
                                                                                    batch_size_received,
                                                                                    *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                                    tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                                    tmp_ptr_layer_it);
...
void Neural_Network::FF__Forward_Pass_Batch__Pre_Training__OpenMP(size_t const batch_size_received, T_ const *const *const ptr_array_inputs_received)
{
    ...
    // Input layer.
    this->FF__Assign_Inputs__Pre_Training__OpenMP(batch_size_received, ptr_array_inputs_received);
    // |END| Input layer. |END|
    ...
    for(; tmp_ptr_layer_it != tmp_ptr_last_layer; ++tmp_ptr_layer_it)
    {
        ...
        {
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED:
                this->Forward_Pass__Encode__FC__OpenMP(0_zu,
                                                                                     batch_size_received,
                                                                                     *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                                     tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                                     tmp_ptr_layer_it);
    ...
    {
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED:
            this->Forward_Pass__Code__FC__OpenMP(0_zu,
                                                                             batch_size_received,
                                                                             *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                             tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                             tmp_ptr_layer_it);
    ...
    {
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED:
            this->Forward_Pass__Decode__FC__OpenMP(0_zu,
                                                                                batch_size_received,
                                                                                *tmp_ptr_previous_connected_layer->ptr_number_outputs,
                                                                                tmp_ptr_previous_connected_layer->ptr_array_outputs,
                                                                                tmp_ptr_layer_it);
...
void Neural_Network::Forward_Pass__Average_Pooling__OpenMP(size_t const time_step_index_received,
...
void Neural_Network::Forward_Pass__FC__OpenMP(size_t const time_step_index_received,
                                                                            size_t const batch_size_received,
                                                                            size_t const input_size_received,
                                                                            T_ const *const ptr_array_inputs_received,
                                                                            struct Layer *const ptr_layer_it_received)
    ...
    if(this->type_state_propagation == MyEA::Common::ENUM_TYPE_STATE_PROPAGATION::TYPE_STATE_PROPAGATION_TRAINING)
    {
        ...
        switch(ptr_layer_it_received->type_dropout)
        {
            case MyEA::Common::ENUM_TYPE_LAYER_DROPOUT::TYPE_LAYER_DROPOUT_BERNOULLI:
                this->Forward_Pass__Dropout__Bernoulli__Training__OpenMP(ptr_layer_it_received->ptr_array__mask__dropout__bernoulli,
            ...
            case MyEA::Common::ENUM_TYPE_LAYER_DROPOUT::TYPE_LAYER_DROPOUT_BERNOULLI_INVERTED:
                this->Forward_Pass__Dropout__Bernoulli__Inverted__OpenMP(ptr_layer_it_received->ptr_array__mask__dropout__bernoulli,
                                                                                                          time_step_index_received,
                                                                                                          batch_size_received,
                                                                                                          tmp_output_size,
...
void Neural_Network::Forward_Pass__Encode__FC__OpenMP(size_t const time_step_index_received,
                                                                                      size_t const batch_size_received,
                                                                                      size_t const input_size_received,
                                                                                      T_ const *const ptr_array_inputs_received,
                                                                                      struct Layer *const ptr_layer_it_received)
...
void Neural_Network::Forward_Pass__Code__FC__OpenMP(size_t const time_step_index_received,
                                                                                        size_t const batch_size_received,
                                                                                        size_t const input_size_received,
                                                                                        T_ const *const ptr_array_inputs_received,
                                                                                        struct Layer *const ptr_layer_it_received)
...
void Neural_Network::Forward_Pass__Decode__FC__OpenMP(size_t const time_step_index_received,
                                                                                           size_t const batch_size_received,
                                                                                           size_t const input_size_received,
                                                                                           T_ const *const ptr_array_inputs_received,
                                                                                           struct Layer *const ptr_layer_it_received)
...
void Neural_Network::Forward_Pass__LSTM__OpenMP(long long int const time_step_index_received,
...
void Neural_Network::Forward_Pass__Encode__LSTM__OpenMP(long long int const time_step_index_received,
                                                                                                long long int const tmp_time_step_reverse_direction,
                                                                                                long long int const tmp_time_step_start,
                                                                                                size_t const batch_size_received,
                                                                                                size_t const input_size_received,
...
void Neural_Network::Forward_Pass__Code__LSTM__OpenMP(long long int const time_step_index_received,
                                                                                       long long int const tmp_time_step_reverse_direction,
                                                                                       long long int const tmp_time_step_start,
                                                                                       size_t const batch_size_received,
                                                                                       size_t const input_size_received,
...
void Neural_Network::Forward_Pass__Decode__LSTM__OpenMP(long long int const time_step_index_received,
                                                                                          long long int const tmp_time_step_reverse_direction,
                                                                                          long long int const tmp_time_step_start,
                                                                                          size_t const batch_size_received,
                                                                                          size_t const input_size_received,
...
void Neural_Network::Forward_Pass__Max_Pooling__OpenMP(size_t const time_step_index_received,
                                                                                            size_t const batch_size_received,
                                                                                            size_t const input_size_received,
                                                                                            T_ const *const ptr_array_inputs_received,
                                                                                            struct Layer *const ptr_layer_it_received)
...
void Neural_Network::Forward_Pass__Residual__OpenMP(size_t const batch_size_received, struct Layer *&ptr_layer_it_received)
{
    T_ *tmp_ptr_array_inputs;
    ...
    if(tmp_ptr_residual_layer->Use__Normalization())
    {
        ...
        if(this->type_state_propagation >= MyEA::Common::ENUM_TYPE_STATE_PROPAGATION::TYPE_STATE_PROPAGATION_TRAINING)
        {
            ...
            {
                case MyEA::Common::ENUM_TYPE_LAYER_NORMALIZATION::TYPE_LAYER_NORMALIZATION_BATCH_NORMALIZATION:
                    this->Forward_Pass__Batch_Normalization__Training__OpenMP(0_zu,
                                                                                                             batch_size_received,
                                                                                                             *ptr_layer_it_received->ptr_number_outputs,
                                                                                                             tmp_ptr_array_inputs,
                        ...
                        break;
                case MyEA::Common::ENUM_TYPE_LAYER_NORMALIZATION::TYPE_LAYER_NORMALIZATION_BATCH_RENORMALIZATION:
                    this->Forward_Pass__Batch_Renormalization__Training__OpenMP(0_zu,
                                                                                                                batch_size_received,
                                                                                                                *ptr_layer_it_received->ptr_number_outputs,
                                                                                                                tmp_ptr_array_inputs,
                                                                                                                tmp_ptr_residual_first_normalized_unit->normalized_batch_units.ptr_scale,
        ...
        {
            this->Forward_Pass__Batch_Normalization__Inference__OpenMP(0_zu,
                                                                                                      batch_size_received,
                                                                                                      *ptr_layer_it_received->ptr_number_outputs,
                                                                                                      tmp_ptr_array_inputs,
                                                                                                      tmp_ptr_residual_first_normalized_unit->normalized_batch_units.ptr_scale,
    ...
    if(tmp_ptr_residual_layer->type_dropout == MyEA::Common::ENUM_TYPE_LAYER_DROPOUT::TYPE_LAYER_DROPOUT_SHAKEDROP)
    {
        ...
        if(this->type_state_propagation == MyEA::Common::ENUM_TYPE_STATE_PROPAGATION::TYPE_STATE_PROPAGATION_TRAINING)
        {
            this->Forward_Pass__Dropout__ShakeDrop__OpenMP(0_zu,
                                                                                             batch_size_received,
                                                                                             *ptr_layer_it_received->ptr_number_outputs,
    ...
    this->Forward_Pass__Zero_Padded_Identity__OpenMP(0_zu,
                                                                                   batch_size_received,
...
void Neural_Network::Forward_Pass__Residual__Layer__OpenMP(bool const is_block_input_layer_received,
                                                                                                 size_t const batch_size_received,
...
void Neural_Network::Forward_Pass__Residual__FC__OpenMP(bool const is_block_input_layer_received,
...
void Neural_Network::Forward_Pass__Bias__OpenMP(size_t const time_step_index_received,
                                                                               size_t const batch_size_received,
                                                                               size_t const output_size_received,
...
void Neural_Network::Forward_Pass__Batch_Normalization__Inference__OpenMP(size_t const time_step_index_received,
                                                                                                                       size_t const batch_size_received,
                                                                                                                       size_t const input_size_received,
                                                                                                                       T_ const *const ptr_array_inputs_received,
...
void Neural_Network::Forward_Pass__Batch_Normalization__Training__OpenMP(size_t const time_step_index_received,
                                                                                                                     size_t const batch_size_received,
                                                                                                                     size_t const input_size_received,
                                                                                                                     T_ const *const ptr_array_inputs_received,
                                                                                                                     T_ const *const ptr_array_scales_received,
                                                                                                                     ...
                                                                                                                     T_ *const ptr_array_output_normalizes_received)
{
    ...
    {
        tmp_input_data_timed_index = static_cast<size_t>(tmp_example_index__int) * input_size_received + tmp_input_timed_batched_index;
        tmp_input_thread_timed_index = static_cast<size_t>(omp_get_thread_num()) * input_size_received * this->number_recurrent_depth + tmp_input_timed_index;
    ...
    {
        // Reduction.
        tmp_reduction_mean = 0_T;
        tmp_reduction_variance = 0_T;
        ...
        {
            tmp_reduction_mean += tmp_ptr_array_mean[static_cast<size_t>(tmp_thread_index__int) * input_size_received * this->number_recurrent_depth];
            tmp_reduction_variance += tmp_ptr_array_variance[static_cast<size_t>(tmp_thread_index__int) * input_size_received * this->number_recurrent_depth];
        }
...
void Neural_Network::Forward_Pass__Batch_Renormalization__Training__OpenMP(size_t const time_step_index_received,
                                                                                                                         size_t const batch_size_received,
                                                                                                                         size_t const input_size_received,
                                                                                                                         T_ const *const ptr_array_inputs_received,
                                                                                                                         T_ const *const ptr_array_scales_received,
                                                                                                                         ...
                                                                                                                         T_ *const ptr_array_output_normalizes_received)
{
    ...
    for(tmp_input_index__int = 0; tmp_input_index__int < tmp_units_size__int; ++tmp_input_index__int)
    {
        ...
        *tmp_ptr_array_variance = sqrt(*tmp_ptr_array_variance * tmp_batch_scale - *tmp_ptr_array_mean * *tmp_ptr_array_mean + tmp_epsilon);
        ...
        ptr_array_r_corrections_received[tmp_input_timed_index + static_cast<size_t>(tmp_input_index__int)] = MyEA::Math::Clip<T_>(tmp_gamma, tmp_r_correction, tmp_r_correction_maximum);
        ...
        ptr_array_d_corrections_received[tmp_input_timed_index + static_cast<size_t>(tmp_input_index__int)] = MyEA::Math::Clip<T_>(tmp_d_correction, -tmp_d_correction_maximum, tmp_d_correction_maximum);
    }
...
void Neural_Network::Forward_Pass__FC_AF__OpenMP(size_t const time_step_index_received,
                                                                                   size_t const batch_size_received,
                                                                                   size_t const input_size_received,
                                                                                   T_ const *const ptr_array_inputs_received,
                                                                                   T_ *const ptr_array_outputs_received,
...
void Neural_Network::Forward_Pass__FC_AF__Softmax__OpenMP(size_t const time_step_index_received,
                                                                                                  size_t const batch_size_received,
                                                                                                  size_t const input_size_received,
                                                                                                  T_ const *const ptr_array_inputs_received,
                                                                                                  T_ *const ptr_array_outputs_received)
{
    ...
    for(tmp_example_index__int = 0; tmp_example_index__int < tmp_batch_size__int; ++tmp_example_index__int)
    {
        ...
        for(tmp_input_index = 0_zu; tmp_input_index != input_size_received; ++tmp_input_index) { tmp_layer_maximum_summation = MyEA::Math::Maximum(tmp_layer_maximum_summation, tmp_ptr_array_inputs[tmp_input_index]); }
...
void Neural_Network::Forward_Pass__Dropout__Bernoulli__Inverted__OpenMP(bool const *const ptr_array__mask__dropout__bernoulli_received,
                                                                                                                   size_t const time_step_index_received,
                                                                                                                   size_t const batch_size_received,
                                                                                                                   size_t const input_size_received,
...
void Neural_Network::Forward_Pass__Dropout__Bernoulli__Training__OpenMP(bool const *const ptr_array__mask__dropout__bernoulli_received,
                                                                                                                  size_t const time_step_index_received,
                                                                                                                  size_t const batch_size_received,
                                                                                                                  size_t const input_size_received,
                                                                                                                  T_ *const ptr_array_inputs_received)
...
void Neural_Network::Forward_Pass__Dropout__Bernoulli__Inference__OpenMP(size_t const time_step_index_received,
                                                                                                                    size_t const batch_size_received,
                                                                                                                    size_t const input_size_received,
                                                                                                     ...
                                                                                                     T_ *const ptr_array_inputs_received)
{
    ...
    this->ptr_array_Class_Generator_Real_Gaussian[tmp_thread_index__int].Range(1_T, variance_received);
...
void Neural_Network::Forward_Pass__Dropout__Uout__OpenMP(size_t const time_step_index_received,
                                                                                              size_t const batch_size_received,
                                                                                              size_t const input_size_received,
...
void Neural_Network::Forward_Pass__Zero_Padded_Identity__OpenMP(size_t const time_step_index_received,
                                                                                                        size_t const batch_size_received,
                                                                                                        ...
                                                                                                        T_ *const ptr_array_outputs_received)
{
    ...
    if(padding_received == 0_zu)
    {
        ...
        for(tmp_example_index__int = 0; tmp_example_index__int < tmp_batch_size__int; ++tmp_example_index__int)
        {
            ...
            PRINT_FORMAT("FORWARD, TIME[%zu], DATA[%zu]" NEW_LINE, time_step_index_received, static_cast<size_t>(tmp_example_index__int));
