...
void Neural_Network::Update_Parameters__Adam(size_t const batch_size_received,
                                                                        ...
                                                                        size_t const end_index_received)
{
    ...
    {
        this->Update_Parameters__Adam__OpenMP(batch_size_received,
    ...
    {
        this->Update_Parameters__Adam__Loop(batch_size_received,
                                                                     training_size_received,
                                                                     start_index_received,
                                                                     end_index_received);
    }
...
void Neural_Network::Update_Parameters__Adam__Loop(size_t const batch_size_received,
                                                                                   size_t const training_size_received,
                                                                                   size_t const start_index_received,
                                                                                   size_t const end_index_received)
{
...
void Neural_Network::Update_Parameters__Adam__OpenMP(size_t const batch_size_received,
                                                                                         size_t const training_size_received,
                                                                                         size_t const start_index_received,
                                                                                         size_t const end_index_received)
{
