...
void Neural_Network::Update_Parameters__AMSGrad(size_t const batch_size_received,
                                                                              ...
                                                                              size_t const end_index_received)
{
    ...
    {
        this->Update_Parameters__AMSGrad__OpenMP(batch_size_received,
    ...
    {
        this->Update_Parameters__AMSGrad__Loop(batch_size_received,
                                                                          training_size_received,
                                                                          start_index_received,
                                                                          end_index_received);
    }
...
void Neural_Network::Update_Parameters__AMSGrad__Loop(size_t const batch_size_received,
                                                                                         size_t const training_size_received,
                                                                                         size_t const start_index_received,
                                                                                         size_t const end_index_received)
{
    ...
    if(tmp_weight_decay != 0_T)
    {
        for(tmp_connection_index = start_index_received; tmp_connection_index != end_index_received; ++tmp_connection_index)
        {
            ...
            tmp_previous_biased_second_moment_hat = tmp_ptr_array_previous_biased_second_moment_hat[tmp_connection_index];
            tmp_ptr_array_previous_biased_second_moment_hat[tmp_connection_index] = tmp_previous_biased_second_moment_hat = MyEA::Math::Maximum<T_>(tmp_previous_biased_second_moment_hat, tmp_biased_second_moment);

            tmp_ptr_array_parameters[tmp_connection_index] -= tmp_learning_rate_t * tmp_biased_first_moment / (sqrt(tmp_previous_biased_second_moment_hat) + tmp_epsilon) + tmp_ptr_array_connections_mask_rergularization[tmp_connection_index] * tmp_weight_decay * tmp_ptr_array_parameters[tmp_connection_index];
    ...
    else
    {
        for(tmp_connection_index = start_index_received; tmp_connection_index != end_index_received; ++tmp_connection_index)
        {
            ...
            tmp_ptr_array_parameters[tmp_connection_index] -= tmp_learning_rate_t * tmp_biased_first_moment / (sqrt(tmp_previous_biased_second_moment_hat) + tmp_epsilon);
...
void Neural_Network::Update_Parameters__AMSGrad__OpenMP(size_t const batch_size_received,
                                                                                               size_t const training_size_received,
                                                                                               size_t const start_index_received,
                                                                                               size_t const end_index_received)
{
    ...
    T_ *const tmp_ptr_array_partial_derivative(this->ptr_array_derivatives_parameters),
        ...
        *const tmp_ptr_array_previous_biased_second_moment_hat(this->ptr_array_previous_biased_second_moment_hat),
        ...
        tmp_previous_biased_second_moment_hat(0);
