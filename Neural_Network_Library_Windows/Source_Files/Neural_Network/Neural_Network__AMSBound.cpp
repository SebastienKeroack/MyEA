...
void Neural_Network::Update_Parameters__AMSBound(size_t const batch_size_received,
                                                                                 ...
                                                                                 size_t const end_index_received)
{
    ...
    {
        this->Update_Parameters__AMSBound__OpenMP(batch_size_received,
    ...
    {
        this->Update_Parameters__AMSBound__Loop(batch_size_received,
                                                                             training_size_received,
                                                                             start_index_received,
                                                                             end_index_received);
    }
...
void Neural_Network::Update_Parameters__AMSBound__Loop(size_t const batch_size_received,
                                                                                            size_t const training_size_received,
                                                                                            size_t const start_index_received,
                                                                                            size_t const end_index_received)
{
    ...
    if(tmp_weight_decay != 0_T)
    {
        for(tmp_connection_index = start_index_received; tmp_connection_index != end_index_received; ++tmp_connection_index)
        {
            ...
            tmp_learning_rate_clip_t = MyEA::Math::Clip<T_>(tmp_learning_rate_t / (sqrt(tmp_previous_biased_second_moment_hat) + tmp_epsilon), tmp_learning_rate_lower_bound_t, tmp_learning_rate_upper_bound_t);
...
void Neural_Network::Update_Parameters__AMSBound__OpenMP(size_t const batch_size_received,
                                                                                                 size_t const training_size_received,
                                                                                                 size_t const start_index_received,
                                                                                                 size_t const end_index_received)
{
