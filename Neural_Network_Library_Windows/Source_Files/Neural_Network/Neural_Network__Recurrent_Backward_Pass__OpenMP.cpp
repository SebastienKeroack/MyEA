...
void Neural_Network::RNN__Backward_Pass_Batch__OpenMP(size_t const batch_size_received)
{
    ...
    for(; tmp_ptr_gradient_layer_it != tmp_ptr_second_layer; --tmp_ptr_gradient_layer_it)
    {
            ...
            tmp_ptr_next_layer_end = tmp_ptr_next_layer_it + tmp_ptr_layer_it->next_connected_layers.size(); tmp_ptr_next_layer_it != tmp_ptr_next_layer_end; ++tmp_ptr_next_layer_it)
        {
            switch(tmp_ptr_next_layer_it->type_layer)
            {
                case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_AVERAGE_POOLING:
                    this->Recurrent__Backward_Pass__Average_Pooling__OpenMP(batch_size_received,
                ...
                case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                    this->Recurrent__Backward_Pass__FC__OpenMP(batch_size_received,
                                                                                              tmp_layer_number_outputs,
                                                                                              tmp_ptr_array_layer_gradients,
                                                                                              tmp_ptr_next_layer_it);
                        break;
                case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_LSTM:
                    this->Recurrent__Backward_Pass__LSTM__OpenMP(batch_size_received,
                                                                                                  tmp_layer_number_outputs,
                                                                                                  tmp_ptr_array_layer_gradients,
                                                                                                  tmp_ptr_next_layer_it);
                        break;
                case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_MAX_POOLING:
                    this->Recurrent__Backward_Pass__Max_Pooling__OpenMP(batch_size_received,
                                                                                                             tmp_layer_number_outputs,
                                                                                                             tmp_ptr_array_layer_gradients,
                                                                                                             tmp_ptr_next_layer_it);
                        break;
                case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_RESIDUAL:
                    this->Recurrent__Backward_Pass__Residual__OpenMP(batch_size_received,
                                                                                                 tmp_layer_number_outputs,
                                                                                                 tmp_ptr_array_layer_gradients,
                                                                                                 tmp_ptr_next_layer_it);
                        break;
        ...
        switch(tmp_ptr_layer_it->type_layer)
        {
            ...
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED:
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_RECURRENT:
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_INDEPENDENTLY_RECURRENT: this->Recurrent__Backward_Pass__Gradient__FC__OpenMP(batch_size_received, tmp_ptr_layer_it); break;
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_LSTM:
                ...
                else
                {
                    ...
                    break;
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_RESIDUAL:
                this->Recurrent__Backward_Pass__Gradient__Residual__OpenMP(batch_size_received, tmp_ptr_layer_it);
...
void Neural_Network::RNN__Backward_Pass_Batch__Pre_Training__OpenMP(size_t const batch_size_received)
{
    size_t tmp_layer_number_outputs;
    ...
    switch(tmp_ptr_coded_layer->type_layer)
    {
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED:
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_RECURRENT:
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_INDEPENDENTLY_RECURRENT: this->Recurrent__Backward_Pass__Gradient__FC__OpenMP(batch_size_received, tmp_ptr_coded_layer); break;
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_LSTM:
...
void Neural_Network::Recurrent__Backward_Pass__Average_Pooling__OpenMP(size_t const batch_size_received,
...
void Neural_Network::Recurrent__Backward_Pass__FC__OpenMP(size_t const batch_size_received,
                                                                                                 size_t const derivative_size_received,
                                                                                                 T_ *const ptr_array_derivatives_received,
                                                                                                 struct Layer const *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Backward_Pass__LSTM__OpenMP(size_t const batch_size_received,
                                                                                                      size_t const derivative_size_received,
                                                                                                      T_ *const ptr_array_derivatives_received,
                                                                                                      struct Layer const *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Backward_Pass__Max_Pooling__OpenMP(size_t const batch_size_received,
                                                                                                                size_t const derivative_size_received,
                                                                                                                T_ *const ptr_array_derivatives_received,
                                                                                                                struct Layer const *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Backward_Pass__Residual__OpenMP(size_t const batch_size_received,
                                                                                                          size_t const derivative_size_received,
                                                                                                          T_ *const ptr_array_derivatives_received,
                                                                                                          struct Layer const *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Backward_Pass__Residual__Block__OpenMP(size_t const batch_size_received,
                                                                                                                     size_t const derivative_size_received,
                                                                                                                     T_ *const ptr_array_derivatives_received,
                                                                                                                     struct Layer const *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Backward_Pass__Gradient__FC__OpenMP(size_t const batch_size_received, struct Layer const *const ptr_layer_it_received)
{
    for(size_t tmp_time_step_index(this->number_recurrent_depth); tmp_time_step_index--;)
    {
...
void Neural_Network::Recurrent__Backward_Pass__Gradient__LSTM__OpenMP(bool const forward_layer_received,
...
void Neural_Network::Recurrent__Backward_Pass__Gradient__Residual__OpenMP(size_t const batch_size_received, struct Layer const *const ptr_layer_it_received)
{
...
void Neural_Network::Recurrent__Backward_Pass__Gradient__Residual__Layer__OpenMP(bool const is_block_input_layer_received,
                                                                                                                                     size_t const batch_size_received,
    ...
    switch(tmp_ptr_next_layer_it->type_layer)
    {
        ...
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_MAX_POOLING:
            this->Recurrent__Backward_Pass__Max_Pooling__OpenMP(batch_size_received,
                ...
                break;
        case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_RESIDUAL:
            this->Recurrent__Backward_Pass__Residual__Block__OpenMP(batch_size_received,
                                                                                                        tmp_layer_number_outputs,
                                                                                                        tmp_ptr_array_layer_gradients,
                                                                                                        tmp_ptr_next_layer_it);
                break;
...
void Neural_Network::Recurrent__Backward_Pass__Gradient__Residual__FC__OpenMP(bool const is_block_input_layer_received,
                                                                                                                                 size_t const batch_size_received,
                                                                                                                                 struct Layer const *const ptr_layer_it_received)
{
    for(size_t tmp_time_step_index(this->number_recurrent_depth); tmp_time_step_index--;)
...
void Neural_Network::Backward_Pass__LSTM__OpenMP(size_t const time_step_index_received,
                                                                                    size_t const batch_size_received,
                                                                                    size_t const derivative_input_size_received,
...
void Neural_Network::Backward_Pass__LSTM_Derivative__Output__OpenMP(long long int const time_step_index_received,
...
void Neural_Network::Backward_Pass__LSTM_Derivative__Cell_State_AF__OpenMP(long long int const time_step_index_received,
                                                                                                                            long long int const time_step_direction_received,
...
void Neural_Network::Backward_Pass__LSTM_Derivative__Gates_CIF_AF_State__OpenMP(long long int const time_step_index_received,
                                                                                                                                      long long int const time_step_direction_received,
                                                                                                                                      ...
                                                                                                                                      struct Layer *const ptr_layer_it_received)
{
    ...
    T_ *tmp_ptr_array_delta_cell_inputs,
