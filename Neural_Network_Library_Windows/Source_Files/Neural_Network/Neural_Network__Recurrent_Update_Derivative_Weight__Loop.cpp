...
void Neural_Network::RNN__Update_Derivative_Weight_Batch__Loop(size_t const batch_size_received,
    ...
    for(; ptr_layer_it_received != ptr_layer_end_received; ++ptr_layer_it_received)
    {
        ...
        switch(ptr_layer_it_received->type_layer)
        {
            ...
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_FULLY_CONNECTED_INDEPENDENTLY_RECURRENT:
                this->Recurrent__Update_Derivative_Weight__FC__Loop(batch_size_received,
            ...
            case MyEA::Common::ENUM_TYPE_LAYER::TYPE_LAYER_LSTM:
                ...
                if(ptr_layer_it_received->Use__Bidirectional())
                {
                    ...
                    this->Recurrent__Update_Derivative_Weight__LSTM__Bias__Loop(batch_size_received,
                                                                                                                     tmp_number_units[2u],
                                                                                                                     tmp_number_units[3u],
                                                                                                                     ptr_layer_it_received->ptr_Bidirectional_Layer->forward_layer.ptr_array_cell_units->ptr_delta_cell_input,
                                                                                                                     ptr_layer_it_received->ptr_Bidirectional_Layer->forward_layer.ptr_array_block_units->ptr_delta_inputs_gates,
...
void Neural_Network::RNN__Update_Derivative_Weight_Batch__Pre_Training__Loop(size_t const batch_size_received)
{
    size_t tmp_number_units[4u];
...
void Neural_Network::Recurrent__Update_Derivative_Weight__FC__Loop(size_t const batch_size_received,
...
void Neural_Network::Update_Derivative_Weight__FC_Ind_RNN__Loop(size_t const time_step_index_received,
                                                                                                       ...
                                                                                                       T_ *const ptr_array_derivatives_received)
{
    ...
    for(tmp_example_index = 0_zu; tmp_example_index != batch_size_received; ++tmp_example_index)
    {
        ...
        for(tmp_derivative_index = 0_zu; tmp_derivative_index != derivative_size_received; ++tmp_derivative_index) { ptr_array_derivatives_received[tmp_derivative_index] += tmp_ptr_array_previous_timed_inputs[tmp_derivative_index] * tmp_ptr_array_derivative_inputs[tmp_derivative_index]; }
    }
}

void Neural_Network::Recurrent__Update_Derivative_Weight__LSTM__Loop(bool const forward_layer_received,
                                                                                                              size_t const batch_size_received,
...
void Neural_Network::Recurrent__Update_Derivative_Weight__LSTM__Bias__Loop(size_t const batch_size_received,
