...
template<typename T>
__global__ void kernel__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons(float *const ptr_array_accuracy_values_received,
...
template<typename T>
__global__ void kernel__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons(size_t const size_received,
...
template<typename T>
__global__ void kernel_while__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                              float *const ptr_array_accuracy_values_received,
                                                                                                                                                              float *const ptr_array_loss_values_received,
                                                                                                                                                              float const accurancy_variance_received,
                                                                                                                                                              T const *const ptr_array_output_layer_outputs_received,
...
template<typename T>
__global__ void kernel__CNeural_Network__FF__Test__Standard__Parallel_Batch__Parallel_Neurons(size_t const number_neurons_received,
                                                                                                                                                  float *const ptr_array_accuracy_values_received,
                                                                                                                                                  float *const ptr_array_loss_values_received,
                                                                                                                                                  float const accurancy_variance_received,
                                                                                                                                                  T const *const ptr_array_output_layer_outputs_received,
                                                                                                                                                  ...
                                                                                                                                                  struct dim3 const *const ptr_array_dim3_block_received)
{
    ...
    LAUNCH_KERNEL_POINTER_1D(CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons<T>,
...
template<typename T>
__global__ void kernel__CNeural_Network__FF__Test__Standard__Parallel_Batch__Parallel_Neurons(size_t const size_received,
...
template<typename T>
__global__ void kernel_while__CNeural_Network__FF__Test__Standard__Parallel_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                            size_t const number_neurons_received,
                                                                                                                                                            float *const ptr_array_accuracy_values_received,
                                                                                                                                                            float *const ptr_array_loss_values_received,
                                                                                                                                                            float const accurancy_variance_received,
                                                                                                                                                            ...
                                                                                                                                                            struct dim3 const *const ptr_array_dim3_block_received)
{
    ...
    if(ptr_array_dim3_grid_received->x * ptr_array_dim3_block_received->x < number_neurons_received - 1u) // Subtract bias.
    {
        ...
        do
        {
            ...
            kernel_while__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons<T> <<< *ptr_array_dim3_grid_received, *ptr_array_dim3_block_received >>> (number_neurons_received - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                   ptr_array_accuracy_values_received + blockIdx.x,
                                                                                                                                                                                                                                                                   ptr_array_loss_values_received + blockIdx.x,
                                                                                                                                                                                                                                                                   accurancy_variance_received,
                                                                                                                                                                                                                                                                   ptr_array_output_layer_outputs_received + tmp_thread_global_index * number_neurons_received,
    ...
    else if(ptr_array_dim3_grid_received->x * ptr_array_dim3_block_received->x > number_neurons_received - 1u) // Subtract bias.
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons<T> <<< *ptr_array_dim3_grid_received, *ptr_array_dim3_block_received >>> (number_neurons_received - 1u, // Subtract bias.
                                                                                                                                                                                                                                                          ptr_array_accuracy_values_received + blockIdx.x,
                                                                                                                                                                                                                                                          ptr_array_loss_values_received + blockIdx.x,
                                                                                                                                                                                                                                                          accurancy_variance_received,
                                                                                                                                                                                                                                                          ptr_array_output_layer_outputs_received + tmp_thread_global_index * number_neurons_received,
    ...
    else
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons<T> <<< *ptr_array_dim3_grid_received, *ptr_array_dim3_block_received >>> (ptr_array_accuracy_values_received + blockIdx.x,
                                                                                                                                                                                                                                                          ptr_array_loss_values_received + blockIdx.x,
                                                                                                                                                                                                                                                          accurancy_variance_received,
                                                                                                                                                                                                                                                          ptr_array_output_layer_outputs_received + tmp_thread_global_index * number_neurons_received,
                                                                                                                                                                                                                                                          ptr_array_desired_outputs_received[tmp_thread_global_index],
...
template<typename T>
__global__ void kernel__CNeural_Network__FF__Test__Standard__Parallel_Batch__Serialize_Neurons(size_t const number_neurons_received,
                                                                                                                                                     float *const ptr_array_accuracy_values_received,
                                                                                                                                                     float *const ptr_array_loss_values_received,
                                                                                                                                                     float const accurancy_variance_received,
                                                                                                                                                     T const *const ptr_array_output_layer_outputs_received,
...
template<typename T>
__global__ void kernel__CNeural_Network__FF__Test__Standard__Parallel_Batch__Serialize_Neurons(size_t const size_received,
                                                                                                                                                    size_t const number_neurons_received,
                                                                                                                                                    float *const ptr_array_accuracy_values_received,
                                                                                                                                                    float *const ptr_array_loss_values_received,
                                                                                                                                                    float const accurancy_variance_received,
...
template<typename T>
__global__ void kernel_while__CNeural_Network__FF__Test__Standard__Parallel_Batch__Serialize_Neurons(size_t const size_received,
                                                                                                                                                            size_t const number_neurons_received,
                                                                                                                                                            float *const ptr_array_accuracy_values_received,
                                                                                                                                                            float *const ptr_array_loss_values_received,
                                                                                                                                                            float const accurancy_variance_received,
...
__device__ void CUDA_Neural_Network::FF__Test__Standard(size_t const batch_size_received, T_ **const ptr_array_outputs_received)
{
    ...
    if(USE_PARALLEL && batch_size_received >= warpSize)
    {
        ...
        {
            LAUNCH_KERNEL_1D(CNeural_Network__FF__Test__Standard__Parallel_Batch__Parallel_Neurons<T_>,
                                              tmp_dim3_grid,
                                              tmp_dim3_block,
                                              0_zu,
                                              batch_size_received,
        ...
        {
            LAUNCH_KERNEL_1D(CNeural_Network__FF__Test__Standard__Parallel_Batch__Serialize_Neurons<T_>,
                                               tmp_dim3_grid,
                                               tmp_dim3_block,
                                               0_zu,
                                               batch_size_received,
    ...
    else if(USE_PARALLEL && tmp_number_neuron_units - 1u >= warpSize)
    {
        ...
        if(tmp_ptr_output_layer->ptr_dim3_grid_neurons_DP->x * tmp_ptr_output_layer->ptr_dim3_block_neurons_DP->x < tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel_while__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons<T_> <<< *tmp_ptr_output_layer->ptr_dim3_grid_neurons_DP, *tmp_ptr_output_layer->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                      this->ptr_array_accuracy_values[0u],
                                                                                                                                                                                                                                                                                                                                      this->ptr_array_loss_values,
                                                                                                                                                                                                                                                                                                                                      this->accuracy_variance,
        ...
        else if(tmp_ptr_output_layer->ptr_dim3_grid_neurons_DP->x * tmp_ptr_output_layer->ptr_dim3_block_neurons_DP->x > tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons<T_> <<< *tmp_ptr_output_layer->ptr_dim3_grid_neurons_DP, *tmp_ptr_output_layer->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                                             this->ptr_array_accuracy_values[0u],
                                                                                                                                                                                                                                                                                                                             this->ptr_array_loss_values,
                                                                                                                                                                                                                                                                                                                             this->accuracy_variance,
                                                                                                                                                                                                                                                                                                                             tmp_ptr_output_layer_first_neuron->ptr_array_values + tmp_data_index * tmp_number_neuron_units,
        ...
        else
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__CNeural_Network__FF__Test__Standard__Serialize_Batch__Parallel_Neurons<T_> <<< *tmp_ptr_output_layer->ptr_dim3_grid_neurons_DP, *tmp_ptr_output_layer->ptr_dim3_block_neurons_DP >>> (this->ptr_array_accuracy_values[0u],
                                                                                                                                                                                                                                                                                                                             this->ptr_array_loss_values,
                                                                                                                                                                                                                                                                                                                             this->accuracy_variance,
                                                                                                                                                                                                                                                                                                                             tmp_ptr_output_layer_first_neuron->ptr_array_values + tmp_data_index * tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                             ptr_array_outputs_received[tmp_data_index],
