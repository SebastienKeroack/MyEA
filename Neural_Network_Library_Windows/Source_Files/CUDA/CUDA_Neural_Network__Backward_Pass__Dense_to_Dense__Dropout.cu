                                                                                                                                                                     ...
                                                                                                                                                                     struct CUDA_Layer *const ptr_layer_it_received)
{
    ...
    if(ptr_layer_it_received->ptr_dim3_grid_neurons->x * ptr_layer_it_received->ptr_dim3_block_neurons->x < number_neurons_received - 1u) // Subtract bias.
    {
        ...
        do
        {
            ...
            kernel_while__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons, *ptr_layer_it_received->ptr_dim3_block_neurons >>> (number_neurons_received - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                        tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                        number_neurons_received,
                                                                                                                                                                                                                                                                                                        next_layer_number_neurons_received,
                                                                                                                                                                                                                                                                                                        neurons_total_reduce_error_size_received,
    ...
    else if(ptr_layer_it_received->ptr_dim3_grid_neurons->x * ptr_layer_it_received->ptr_dim3_block_neurons->x > number_neurons_received - 1u) // Subtract bias.
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons, *ptr_layer_it_received->ptr_dim3_block_neurons >>> (number_neurons_received - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                number_neurons_received,
                                                                                                                                                                                                                                                                                                next_layer_number_neurons_received,
                                                                                                                                                                                                                                                                                                neurons_total_reduce_error_size_received,
    ...
    else
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons, *ptr_layer_it_received->ptr_dim3_block_neurons >>> (tmp_thread_global_index,
                                                                                                                                                                                                                                                                                                number_neurons_received,
                                                                                                                                                                                                                                                                                                next_layer_number_neurons_received,
                                                                                                                                                                                                                                                                                                neurons_total_reduce_error_size_received,
                                                                                                                                                                                                                                                                                                tmp_ptr_layer_it_first_neuron->ptr_mask_dropout_bernoulli,
...
__device__ void CUDA_Neural_Network::Backward_Pass__FC_to_FC__Dropout(bool &ref_synchronized_received,
                                                                                                                    ...
                                                                                                                    struct dim3 const *const ptr_dim3_batch_size_block_received)
{
    ...
    if(USE_PARALLEL && batch_size_received >= warpSize)
    {
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Parallel_Neurons<T_>,
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(Backward_Pass__FC_to_FC__Dropout_Bernoulli__Parallel_Batch__Serialize_Neurons<T_>,
                                                              ptr_dim3_batch_size_grid_received,
                                                              ptr_dim3_batch_size_block_received,
                                                              0_zu,
                                                              batch_size_received,
    ...
    if(USE_PARALLEL && tmp_number_neuron_units - 1u >= warpSize)
    {
        ...
        if(ptr_layer_it_received->ptr_dim3_grid_neurons_DP->x * ptr_layer_it_received->ptr_dim3_block_neurons_DP->x < tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel_while__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T_> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons_DP, *ptr_layer_it_received->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                            tmp_data_index,
                                                                                                                                                                                                                                                                                                                                            tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                            tmp_next_layer_number_neurons,
                                                                                                                                                                                                                                                                                                                                            this->neurons_total_reduce_error_size,
        ...
        else if(ptr_layer_it_received->ptr_dim3_grid_neurons_DP->x * ptr_layer_it_received->ptr_dim3_block_neurons_DP->x > tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__Backward_Pass__FC_to_FC__Dropout_Bernoulli__Serialize_Batch__Parallel_Neurons<T_> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons_DP, *ptr_layer_it_received->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                    tmp_data_index,
                                                                                                                                                                                                                                                                                                                                    tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                    tmp_next_layer_number_neurons,
                                                                                                                                                                                                                                                                                                                                    this->neurons_total_reduce_error_size,
