...
template<typename T>
__global__ void kernel__CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons(size_t const number_neurons_received,
...
template<typename T>
__global__ void kernel__CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons(size_t const size_received,
...
template<typename T>
__global__ void kernel_while__CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                                                  size_t const number_neurons_received,
                                                                                                                                                                                  size_t const number_connections_received,
                                                                                                                                                                                  T *const ptr_array_derivatives_paramters_received,
                                                                                                                                                                                  T const *const ptr_array_neuron_units_errors_received,
...
template<typename T>
__global__ void kernel__CNeural_Network__Update_Derivative_Weight__FC__Parallel_Batch__Parallel_Neurons(size_t const number_neurons_received,
                                                                                                                                                                        size_t const number_connections_received,
                                                                                                                                                                        ...
                                                                                                                                                                        struct CUDA_Layer *const ptr_layer_it_received)
{
    ...
    LAUNCH_KERNEL_POINTER_1D(CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T>,
...
template<typename T>
__global__ void kernel__CNeural_Network__Update_Derivative_Weight__FC__Parallel_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                                        size_t const number_neurons_received,
                                                                                                                                                                        size_t const number_connections_received,
                                                                                                                                                                        size_t const total_parameters_allocated_received,
                                                                                                                                                                        T *const ptr_array_derivatives_parameters_received,
...
template<typename T>
__global__ void kernel_while__CNeural_Network__Update_Derivative_Weight__FC__Parallel_Batch__Parallel_Neurons(size_t const size_received,
                                                                                                                                                                                size_t const number_neurons_received,
                                                                                                                                                                                size_t const number_connections_received,
                                                                                                                                                                                size_t const total_parameters_allocated_received,
                                                                                                                                                                                T *const ptr_array_derivatives_parameters_received,
                                                                                                                                                                                ...
                                                                                                                                                                                struct CUDA_Layer *const ptr_layer_it_received)
{
    ...
    if(ptr_layer_it_received->ptr_dim3_grid_neurons->x * ptr_layer_it_received->ptr_dim3_block_neurons->x < number_neurons_received - 1u) // Subtract bias.
    {
        ...
        do
        {
            ...
            kernel_while__CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons, *ptr_layer_it_received->ptr_dim3_block_neurons >>> (number_neurons_received - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                      number_neurons_received,
                                                                                                                                                                                                                                                                                                                                      number_connections_received,
                                                                                                                                                                                                                                                                                                                                      ptr_array_derivatives_parameters_received + blockIdx.x * total_parameters_allocated_received,
                                                                                                                                                                                                                                                                                                                                      tmp_ptr_layer_it_first_neuron->ptr_array_errors + tmp_thread_global_index * number_neurons_received,
    ...
    else if(ptr_layer_it_received->ptr_dim3_grid_neurons->x * ptr_layer_it_received->ptr_dim3_block_neurons->x > number_neurons_received - 1u) // Subtract bias.
    {
        ...
        {
            // Parallel each neurons for doing a reduction of summation.
            kernel__CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons, *ptr_layer_it_received->ptr_dim3_block_neurons >>> (number_neurons_received - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                                             number_neurons_received,
                                                                                                                                                                                                                                                                                                                             number_connections_received,
                                                                                                                                                                                                                                                                                                                             ptr_array_derivatives_parameters_received + blockIdx.x * total_parameters_allocated_received,
                                                                                                                                                                                                                                                                                                                             tmp_ptr_layer_it_first_neuron->ptr_array_errors + tmp_thread_global_index * number_neurons_received,
...
template<typename T>
__global__ void kernel__CNeural_Network__Update_Derivative_Weight__FC__Parallel_Batch__Serialize_Neurons(size_t const number_neurons_received,
                                                                                                                                                                         size_t const number_connections_received,
                                                                                                                                                                         size_t const total_parameters_allocated_received,
                                                                                                                                                                         T *const ptr_array_derivatives_parameters_received,
                                                                                                                                                                         T const *const ptr_array_neuron_units_errors_received,
...
template<typename T>
__global__ void kernel__CNeural_Network__Update_Derivative_Weight__FC__Parallel_Batch__Serialize_Neurons(size_t const size_received,
                                                                                                                                                                         size_t const number_neurons_received,
                                                                                                                                                                         size_t const number_connections_received,
                                                                                                                                                                         size_t const total_parameters_allocated_received,
                                                                                                                                                                         T *const ptr_array_derivatives_parameters_received,
...
template<typename T>
__global__ void kernel_while__CNeural_Network__Update_Derivative_Weight__FC__Parallel_Batch__Serialize_Neurons(size_t const size_received,
                                                                                                                                                                                  size_t const number_neurons_received,
                                                                                                                                                                                  size_t const number_connections_received,
                                                                                                                                                                                  size_t const total_parameters_allocated_received,
                                                                                                                                                                                  T *const ptr_array_derivatives_parameters_received,
...
__device__ void CUDA_Neural_Network::Update_Derivative_Weight__FC_to_FC(bool &ref_synchronized_received,
                                                                                                                     ...
                                                                                                                     struct dim3 const *const ptr_dim3_batch_size_block_received)
{
    ...
    if(USE_PARALLEL && batch_size_received >= warpSize)
    {
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(CNeural_Network__Update_Derivative_Weight__FC__Parallel_Batch__Parallel_Neurons<T_>,
        ...
        {
            LAUNCH_KERNEL_POINTER_1D(CNeural_Network__Update_Derivative_Weight__FC__Parallel_Batch__Serialize_Neurons<T_>,
                                                              ptr_dim3_batch_size_grid_received,
                                                              ptr_dim3_batch_size_block_received,
                                                              0_zu,
                                                              batch_size_received,
    ...
    else if(USE_PARALLEL && tmp_number_neuron_units - 1u >= warpSize)
    {
        ...
        if(ptr_layer_it_received->ptr_dim3_grid_neurons_DP->x * ptr_layer_it_received->ptr_dim3_block_neurons_DP->x < tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel_while__CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T_> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons_DP, *ptr_layer_it_received->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                                         tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                                         tmp_number_connections,
                                                                                                                                                                                                                                                                                                                                                         this->ptr_array_derivatives_parameters + *tmp_ptr_layer_it_first_neuron->ptr_first_forward_connection_index,
        ...
        else if(ptr_layer_it_received->ptr_dim3_grid_neurons_DP->x * ptr_layer_it_received->ptr_dim3_block_neurons_DP->x > tmp_number_neuron_units - 1u) // Subtract bias.
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T_> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons_DP, *ptr_layer_it_received->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units - 1u, // Subtract bias.
                                                                                                                                                                                                                                                                                                                                                tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                                tmp_number_connections,
                                                                                                                                                                                                                                                                                                                                                this->ptr_array_derivatives_parameters + *tmp_ptr_layer_it_first_neuron->ptr_first_forward_connection_index,
                                                                                                                                                                                                                                                                                                                                                tmp_ptr_layer_it_first_neuron->ptr_array_errors + tmp_data_index * tmp_number_neuron_units,
        ...
        else
        {
            ...
            {
                // Parallel each neurons for doing a reduction of summation.
                kernel__CNeural_Network__Update_Derivative_Weight__FC__Serialize_Batch__Parallel_Neurons<T_> <<< *ptr_layer_it_received->ptr_dim3_grid_neurons_DP, *ptr_layer_it_received->ptr_dim3_block_neurons_DP >>> (tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                                tmp_number_connections,
                                                                                                                                                                                                                                                                                                                                                this->ptr_array_derivatives_parameters + *tmp_ptr_layer_it_first_neuron->ptr_first_forward_connection_index,
                                                                                                                                                                                                                                                                                                                                                tmp_ptr_layer_it_first_neuron->ptr_array_errors + tmp_data_index * tmp_number_neuron_units,
                                                                                                                                                                                                                                                                                                                                                tmp_ptr_previous_layer_first_neuron->ptr_array_values + tmp_data_index * (tmp_number_connections + 1u), // Add bias.
