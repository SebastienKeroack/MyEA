    ...
    namespace Common
    {
                                                                                                                     ...
                                                                                                                     wchar_t const *const ptr_class_name_received)
        {
            if(ptr_global_Shutdown_Block == nullptr)
            {
                ...
                ptr_global_Shutdown_Block = new class Shutdown_Block(std::string(tmp_window_name.begin(), tmp_window_name.end()), std::string(tmp_class_name.begin(), tmp_class_name.end()));
